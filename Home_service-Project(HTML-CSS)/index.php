  ...
  <section id="services">
    <div class="container text-center">
      ...
      <ul class="services-list">
        <li><a href="service_detail.php"><img src="images/services-icons/cleaning.png" alt="cleaning" /><br />
          Cleaning</a></li>
        ...
        <li><a href="#"><img src="images/services-icons/plumbing.png" alt="plumbing" /><br />
          Plumbing</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/appliances.png" alt="appliances" /><br />
          Appliances</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/carpentry.png" alt="carpentry" /><br />
          Carpentry</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/geyser.png" alt="geyser" /><br />
          Geyser Service</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/vehicle.png" alt="vehicle" /><br />
          Vehicle Care</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/pest.png" alt="pest" /><br />
          Pest Control</a></li>
        <li><a href="service_detail.php"><img src="images/services-icons/painting.png" alt="painting" /><br />
          Painting</a></li>
